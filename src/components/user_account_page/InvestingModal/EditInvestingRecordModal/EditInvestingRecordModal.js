...
function EditInvestingRecordModal({ record, onClose, onSave, fetchInvestingRecords }) {
    ...
    const saveChanges = async () => {
        try {
            const response = await fetch(`${apiUrl}/investing_records/${record.user_id}/${record.id}/`, {
                method: 'PATCH',
                headers: {
    ...
    return (
        <div className="edit-modal">
            <div className="edit-modal-content">
                ...
                />
                <button onClick={saveChanges} className="edit-modal-button">Save</button>
                <button onClick={onClose} className="edit-modal-button-cancel">Cancel</button>
            </div>
        </div>
    );
}
